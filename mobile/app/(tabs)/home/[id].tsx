...
//         userId: "0c6e2690-4b39-467c-bc28-1606fdd40a95",
//         productId: "10f13184-f55b-468f-b9ed-58970d0c82f7",
//       }).unwrap();
...
function ProductCard({
  ...
  const handleFavorite = () => {
    setIsFavorite(!isFavorite);
    onAddToWishlist(product.id); // ✅ dynamic id
  };
          ...
          >
            {products.map((product: any) => (
              <TouchableOpacity
                key={product.id}
                activeOpacity={0.9}
                // onPress={() => router.push(`/product/${product.id}`)} // optional
              >
                <ProductCard
                  product={product}
